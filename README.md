...
Dear user,
Welcome to Sleepy_Thespian's Skyscrapersim GitHub repo!
...
1: Locate the desired file in my repo. If I have a lot of buildings here, the organization is as follows:
  ...
  Layer 3 - Campus/Complex (If applicable); If a building is a member of a campus, under the folder of its respective city, there will be a folder with the campus name as the folder name, and all buildings that are part of that campus will be contained in that folder.
  Building - All building files have file extension bld.
2: Click download button up on top right of the repository interface.
3: Locate the file. Under default config for Windows 11, it's your Downloads folder in your C drive.
...
"Skyscraper refuses to load the building, throwing an error and returning to main menu"
-If you encounter this with one of my buildings, please post an issue to the repo with the following: Console output, error message, building name, campus folder if the building came in one, city folder and what OS you're using. Additionally, it would be nice to know what other integration project(s) you have in case there's conflicts or data is missing.
